      ...
      <div className="space-y-8 max-w-3xl relative z-10 w-full">
        ...
        >
          ...
          <p className="text-lg md:text-xl text-slate-500 dark:text-slate-400 leading-relaxed font-normal mb-8">
            Infrastructure Specialist specializing in architecting secure enterprise systems and maintaining high-availability networks. Dedicated to operational excellence through proactive identity management, cloud optimization, and the strategic deployment of scalable digital environments.
          </p>
